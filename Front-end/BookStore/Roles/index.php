                ...
                <div class="item_content">
                    <div class="item_header">
                        ...
                        <div class="item_navbar">
                            <a href="">Trang chủ</a> / <a href="/../../php-dotnetcore/Front-end/BookStore/Roles/">Chức vụ nhân viên</a>
                        </div>
                    </div>
                                ...
                                <?php foreach($data as $value): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" style="display: flex;column-gap: 5px;justify-content:flex-end">
                                            <a href="/../../php-dotnetcore/Front-end/BookStore/Roles/edit.php?id=<?=$value["id"]?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
